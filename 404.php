...
<head>
    <meta charset="utf-8">
    <title>Chrisbo HB Champions Club | Not Found</title>
    ...
    <!-- Facebook meta tags -->
    <meta property="og:title" content="Chrisbo Champions Club | Not Found" />
    ...
    <!-- Twitter meta tags -->
    <meta name="twitter:title" content="Chrisbo Champions Club | Not Found" />
        ...
        <div class="theme_container">
            <div class="row text-center">
                <div class="error-block">
                    <div class="image"><img src="assets/images/404.png" alt=""></div>
                    <h3>OOPS!</h3>
                    <div class="text">We’re Sorry the page you’re trying to access can’t be found</div>
                    <div class="error-button"><a href="index.php" class="primary_btn-ten">Go to Home <i class="far fa-arrow-right"></i></a></div>
                </div>
            </div>
        </div>
    </section>
