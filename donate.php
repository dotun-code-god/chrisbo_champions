...
<head>
    <meta charset="utf-8">
    <title>Chrisbo HB Champions Club | Donate</title>
    ...
    <!-- Facebook meta tags -->
    <meta property="og:title" content="Chrisbo Champions Club | Donate" />
    ...
    <!-- Twitter meta tags -->
    <meta name="twitter:title" content="Chrisbo Champions Club | Donate" />
...
<body>
        ...
        <div class="theme_container">
            <div class="content-box">
                ...
                <div class="content-wrapper">                    
                    <div class="title">
                        <h1>Donate to Chrisbo</h1>
                    </div>
                    <ul class="bread-crumb">
                        <li><a href="index.php">Home</a></li>
                        <li>Donate to Chrisbo</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="donate-page donate-form-s-one">
        <div class="theme_container">
            <div class="row">
                        ...
                        <div class="col-md-12"> 
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Donate Offline</h3>
                                </div>
                                <div class="panel-body">
                                    <p>Account Number - <span>0617457393</span></p>
                                    <p>Account Name - <span>Chrisbo Champions Club</span></p>
                                    <p>Bank Name - <span>GTBank</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
